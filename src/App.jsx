...
const App = () => {
  return (
    ...
    <CardTemplate bgcolor="darkGreen" structure="card" textsize="largeText" size="small" icon='assets/images/Group 4.svg' title='LUXURY' textContent='Cruise in the best car brands without the bloated prices. Enjoy the enhanced comfort of a luxury rental and arrive in style. '>
    </CardTemplate>
    </CardsDiv>
    </>
  );
